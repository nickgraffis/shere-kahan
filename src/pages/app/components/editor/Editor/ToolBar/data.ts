...
export const ButtonToActionMap: ButtonToAction = {
	...
	bold: {
		...
		isActive: (editor) => editor?.isActive ? editor.isActive("bold") : false,
	},
	italic: {
		action: (editor) => editor?.chain().focus().toggleItalic().run(),
		isActive: (editor) => editor?.isActive ?  editor?.isActive("italic") : false,
	},
	underline: {
		action: (editor) => editor?.chain().focus().toggleUnderline().run(),
		isActive: (editor) => editor?.isActive ?  editor?.isActive("underline") : false,
	},
	strikethrough: {
		action: (editor) => editor?.chain().focus().toggleStrike().run(),
		isActive: (editor) => editor?.isActive ?  editor?.isActive("strike") : false,
	},
	code: {
	...
	sink: {
		...
		isActive: (editor) => editor?.isActive ?  editor?.isActive("sink") : false,
	},
	lift: {
		action: (editor) => {
			const item = editor?.isActive("listItem") ? "listItem" : "taskItem"
		...
		isActive: (editor) => editor?.isActive ?  editor?.isActive("lift") : false,
	},
	json: {
