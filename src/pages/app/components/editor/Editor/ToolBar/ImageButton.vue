...
<template>
  ...
  >
    ...
    >
      <div
        ref="button"
        @click="editor?.chain().focus().setImage({ src: 'https://images.unsplash.com/photo-1608096299230-81c7b43d5dfc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDEzfGVkUU9taWhlVXRZfHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=900&q=60' }).run()"
      >
        <slot />
      </div>
    </PopoverButton>
          ...
          >
            <div class="flex space-x-2">
              ...
              >
                ...
                >
                  <ri:check-fill
                    v-if="editor?.isActive('highlight', { color })"
                    class="w-5 h-5"
                  />
                </div>
              </div>
