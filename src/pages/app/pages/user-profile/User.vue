      ...
      <div class="space-y-6">
        ...
        <div class="space-y-2">
          <div>
            ...
            >Name</label>
            <p class="text-sm">
              Your display name; used for mentions, collaborative editing and attribution.
            </p>
          </div>
          <input
            v-if="data"
        ...
        <div class="space-y-2">
          <div>
            <label
              for="name"
              class="font-medium flex space-x-2 items-center text-lg"
            >
              <span>Email</span>
            ...
            <p class="text-sm">
              Your email address is important to reset your password. We don't send you any spam emails, and adjust your notification settings if you don't want any emails.
            </p>
          </div>
          <input
            v-if="data"
        ...
        <div class="space-y-2">
          <div>
            ...
            >Birthdate</label>
            <p class="text-sm">
              Seems invasive? No need to respond, but it's always fun to get a happy birthday!
            </p>
          </div>
          <div class="birthday">
            <div
        ...
        <div class="flex justify-start">
          <div
            class="px-6 py-3 rounded-lg bg-blue-500 text-white font-semibold cursor-pointer hover:bg-blue-600"
            @click="performUpdate()"
          >
            Update Profile
          </div>
...
const name = ref(data.value?.account?.data.name)
const email = ref(data.value?.account?.data.email)
